					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
							<ul>
								...
								<li class="has-dropdown active"><a href="men.html">Men</a>
									<ul class="dropdown">
								...
								<%  List<cart> list1 = cartdao.cartproduct(c1.getId());%>
								<li class="cart"><a href="cart.jsp"><i
										class="icon-shopping-cart"></i> Cart [ <%out.print(list1.size()); %>]</a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread">
							<span><a href="index.html">Home</a></span> / <span>Product
								Details</span>
						</p>
					</div>
				</div>
				...
				<div class="row row-pb-lg product-detail-wrap">
					...
					<div class="col-sm-4">
						...
						<img src="image/<%=p.getImage()%>" class="img-responsive" alt="">
							...
							<h3><%=p.getPcategory() %></h3>


							<div class="row">
								<div class="col-sm-12 text-center">
									<p class="addtocart">
										<a href="cartcontroller?action=addtocart&cusid=<%=c1.getId() %>&pid=<%=p.getPid() %>" class="btn btn-primary btn-addtocart"><i
											class="icon-shopping-cart"></i> AddtoCart</a>
									</p>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12 text-center">
									<p class="addtocart">
										<a href="wishlistcontroller?action=addtowishlist&cusid=<%=c1.getId() %>&pid=<%=p.getPid() %>" class="btn btn-primary btn-addtocart"><i
											></i> AddtoWishlist</a>
									</p>
								</div>
							</div>
