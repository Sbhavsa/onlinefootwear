...
%>
	...
	<div class="register">
		<h2> Upload Product </h2>
			...
			<input type="file" name="image" height=200 width=200><br><br>
			<label>Product Name:</label>
			<input type="text" name="pn" placeholder="Enter your product name" ><br><br><br>
			<label>Product Price</label>
			<input type="text" name="pp" placeholder="Enter your product price"><br><br><br>
			<label>Product Category</label>
			<input type="text" name="pc" placeholder="Enter your Product Category"><br><br><br>
