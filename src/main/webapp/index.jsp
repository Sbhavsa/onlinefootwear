					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
							<ul>
								...
								<li class="has-dropdown"><a>Register</a>
									<ul class="dropdown">
										<li><a href="seller-register.jsp">Seller</a></li>
										<li><a href="customer-register.jsp"> customer</a></li>
										<li><a href="admin-register.jsp"> Admin</a></li>


									</ul></li>

								<li class="has-dropdown"><a>Login</a>
									<ul class="dropdown">
			...
			<div class="container">
					...
					<div class="row row-pb-md">
						<div class="col-lg-3 mb-4 text-center">
							...
							<img src="image/<%=p.getImage() %>"  class="img-fluid" alt="Free html4 bootstrap 4 template">
							</div>
								<h2>
									<a href="#"><%=p.getPname() %></a>
								</h2>
