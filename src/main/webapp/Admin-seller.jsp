...
<link rel="stylesheet"
	href="vendors/mdi/template/css/materialdesignicons.min.css">
<link rel="stylesheet"
	href="vendors/ti-icons/template/css/themify-icons.css">
<link rel="stylesheet" href="vendors/typicons/typicons.css">
<link rel="stylesheet"
	href="vendors/simple-line-icons/template/css/simple-line-icons.css">
<link rel="stylesheet"
	href="vendors/template/css/vendor.bundle.base.css">
<!-- endinject -->
					...
					<li class="nav-item dropdown d-none d-lg-block"><a
						...
						<div
							...
							<a class="dropdown-item py-3">
								<p class="mb-0 font-weight-medium float-left">Select
									category</p>
							</a>
							...
							<a class="dropdown-item preview-item">
								<div class="preview-item-content flex-grow py-2">
									<p
										class="preview-subject ellipsis font-weight-medium text-dark">Bootstrap
										Bundle</p>
								...
								<div class="preview-item-content flex-grow py-2">
									<p
										class="preview-subject ellipsis font-weight-medium text-dark">Angular
										Bundle</p>
								...
								<div class="preview-item-content flex-grow py-2">
									<p
										class="preview-subject ellipsis font-weight-medium text-dark">VUE
										Bundle</p>
								...
								<div class="preview-item-content flex-grow py-2">
									<p
										class="preview-subject ellipsis font-weight-medium text-dark">React
										Bundle</p>
