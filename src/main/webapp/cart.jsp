					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
							<ul>
								...
								<%
								List<cart> list2 = cartdao.cartproduct(c1.getId());
								%>
								<%
								if (list2.size() > 0) {
								%>
			...
			<div class="container">
				<div class="row row-pb-lg">
					<div class="col-md-12">
						...
						<%
						List<cart> list3 = cartdao.cartproduct(c1.getId());
						%>
						<%
						for (cart c2 : list3) {
						%>
						<%
						product p = productdao.getproductbyid(c2.getPid());
						%>

						<div class="product-cart d-flex">
							<div class="one-forth">
								<div class="product-img"
									style="background-image: url(image/<%=p.getImage()%>);">
								</div>
							...
							<input  type="number" name="quantity" value="<%=c2.getQuantity() %>" onchange="this.form.submit()" >
							<div class="one-eight text-center">
					...
					<div class="col-md-12">
						<div class="total-wrap">
							<div class="row">
								...
								<%
								List<cart> list4 = cartdao.cartproduct(c1.getId());
								%>
								<%
								...
								%>
								<%
								product p = productdao.getproductbyid(c4.getPid());
								%>
								<%
								total_price = total_price + p.getPprice();
								%>
								<%
								}
								%>
