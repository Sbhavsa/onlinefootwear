	...
	<form action="sellercontroller" method="post">
		<div class="main">
			<div class="register">
				...
				<input type="hidden" name="id" placeholder="Enter your  name"
					value="<%=s.getId()%>"> <label> name:</label><br> <input
					type="text" name="name" placeholder="Enter your  name"
					value="<%=s.getName()%>"> <br> <label>contact:</label><br>
				<input type="text" name="contact" id="Contact"
					placeholder="Enter your Contact" value="<%=s.getContact()%>">
				<br> <label>Address:</label><br> <input type="text"
					name="address" id="address" placeholder="Enter your address"
					value=" <%=s.getAddress()%> "> <br> <label>Email:</label><br>
				<input type="email" name="email" id="email"
					placeholder="Enter your email" value="<%=s.getEmail()%>"> <br>
