					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
							<ul>
								...
								<li ><a href="customer-register.jsp">Register</a>
									</li>

								<li ><a href="customer-login.jsp">Login</a>
									</li>
				...
				<div class="row row-pb-md">
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							...
							<h2><a href="#"><%=p.getPcategory() %></a></h2>    
								<div class="col-sm-4 text-center">
						<div class="featured">
								<br><p><a href="single-product.jsp?id=<%=p.getPid()%>" class="btn btn-primary btn-lg">view</a></p>
							</div>
						</div>
