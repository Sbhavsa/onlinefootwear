...
{  
					...
					<div class="row">
						<div class="col-sm-12 text-left menu-1">
							<ul>
								...
								<li class="has-dropdown" class="active"><a>Register</a>
									<ul class="dropdown">
								...
								<li class="has-dropdown" class="active"><a>Login</a>
									<ul class="dropdown">
	...
	<div class="register">
		...
		<h2>Seller-Register here...</h2>
		    ...
		    <input type="email" name="email" id="email" onblur="searchInfo()" placeholder="Enter your email">
